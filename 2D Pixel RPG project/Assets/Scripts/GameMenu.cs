...
public class GameMenu : MonoBehaviour
{
    ...
    public Text statusName, statusHP, statusMP, statusStr, statusDef, statusWpnEqd, statusWpnPwr, statusArmrEqpd, statusArmrPwr, statusExp;
    ...
    public void StatusChar(int selected)
    {
        ...
        {
            statusWpnEqd.text = playerStats[selected].equippedWpn;
        }
    ...
    public void PlayDiscardItemSound()
    {
